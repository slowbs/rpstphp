<?php 
    ...
    $hospname = $_SESSION['user']['hospname'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<a href="../user"><button type="button" class="btn btn-danger" style="width:100px">ยกเลิก</button></a>
</div>
<div align="right">
<div class="btn-group">
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
      <br>
  <form method="post" action="updateinfo.php?hospcode=<?php echo $ap?>" id="profile">
...
<div class="modal fade" id="exampleModal_<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <a href = "deleteuser.php?fn=<?php echo $row['name']?>">
