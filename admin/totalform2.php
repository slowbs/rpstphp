...
?>
  ...
  <style>
  th.freeze1, td.freeze1
{
  position:sticky !important;
  left:5px;
}
th.freeze2, td.freeze2
{
  position:sticky !important;
  left:58px;
  border-left: solid 1px RED !important;
}
th.freeze3, td.freeze3
{
  position:sticky !important;
  left:113px;
}
td.freeze1, td.freeze2, td.freeze3
 {
...
try {
  ...
  $i=0;
    ...
    <tr>
      <td align="center" class="freeze1"><?php echo $row['pa']?></td>
      <td align="center" class="freeze2"><?php echo $row['lumdub']?></td>
      <td class="freeze3"><?php echo $row['name']?></td>
