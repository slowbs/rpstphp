...
?>
  ...
  <script src="fuk.js"></script>
    <style type="text/css">
        textarea {display: block !important; padding: 3px 0 0 0 !important; margin: 0 !important; width: 100% !important; min-height: 100% ! important;
        border-radius: 0 !important; line-height: 1 !important; border: 0 !important; resize:none !important; overflow-y: hidden !important;}

        td {margin: 0 !important; padding: 0 !important; height: 23px !important;}
...
try {
  ...
  $i=0;
    ...
    <tr>
      ...
      <td><textarea rows="1" class="test <?php echo $row['kor']?>" style="text-align:center;" value="<?php echo $row["value"]?>" 
